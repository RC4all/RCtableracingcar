...
(function () {
  ...
  window.RC_REFERENCE = {
    models: [
      ...
      { id: 'C61 → C66', cat: 'drift',      chassis: 'TC-03 / TC-04', usage: 'Drift',      prix: 90,  note: 'Pneus métalliques, dérive volontaire et contre-braquage. Spectaculaire, mais pas fait pour le chrono. Sortie entre 2022 et 2025.', thumb: 'photos/c66-drift.webp' },
      ...
      { id: 'C76',       cat: 'racing',     chassis: 'TC-06',       usage: 'Référence', prix: 85,  note: 'La meilleure : précision et vitesse au prix le plus juste. Notre base de comparaison. Sortie en 2025.', thumb: 'photos/model-c76-no-text.png', star: true },
      { id: 'C76LE',     cat: 'racing',     chassis: 'TC-06',       usage: 'Racing', prix: 95,  note: 'Identique à la C76, carrosserie plus détaillée. Sortie en 2025.', thumb: 'photos/model-c76le.png' },
      { id: 'C78',       cat: 'racing',     chassis: 'TC-06',       usage: 'Racing', prix: 100, note: 'Même base que la C76, carrosserie plus détaillée et prix plus élevé. Sortie en 2026.', thumb: 'photos/c78-rallye.webp' },
