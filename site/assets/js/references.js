...
(function () {
  ...
  window.RC_REFERENCE = {
    models: [
      ...
      { id: 'C76',       cat: 'racing',     chassis: 'v3 TC-06', usage: 'Référence',    prix: 85,  note: 'La meilleure : précision et vitesse au prix le plus juste. Notre base de comparaison.', star: true },
      { id: 'C76LE',     cat: 'racing',     chassis: 'v3 TC-06', usage: 'Racing',       prix: 95,  note: 'Identique à la C76, carrosserie plus détaillée.' },
      { id: 'C78',       cat: 'racing',     chassis: 'v3 TC-06', usage: 'Racing',       prix: 100, note: 'Même base que la C76, carrosserie plus détaillée et prix plus élevé.' },
