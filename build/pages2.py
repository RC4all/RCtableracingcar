...
<section class="section">
  <div class="wrap">
    ...
    <figure class="fig" style="max-width:760px;margin-inline:auto;margin-bottom:44px" data-reveal="scale">
      ...
      <figcaption><strong>L’intérieur du châssis.</strong> L’ouverture est nécessaire de temps en temps pour retirer
    ...
    <figure class="fig exploded" style="margin-bottom:44px" data-reveal="scale">
      ...
      <figcaption>Vue éclatée du constructeur, <strong>légendes traduites</strong> : les deux zones à surveiller en usage sont la direction et la transmission.</figcaption>
    </figure>
    ...
    <div class="grid g-side" style="margin-bottom:48px;align-items:start">
      ...
      <dl class="specs" data-reveal="right">
        ...
        <div><dt>Régime max.</dt><dd>≈ 42 000 tr/min</dd></div>
      ...
      <div class="tool-body grid g-side" style="align-items:start;gap:28px">
        <div class="radio-map" data-radio-map>
          <img src="img/radio-schema.svg" width="900" height="620" loading="lazy" decoding="async"
               alt="Radiocommande RC à poignée pistolet et volant, vue de trois quarts arrière : volant de direction à gauche, gâchette des gaz en forme de gâchette de fusil avec accélération vers la droite et freinage vers la gauche, écran central, molettes ST-D/R, ST-TRM, TH-TRM et TH-D/R, limiteur TH.LIM, inverseur ST-REV, boutons CH3 et CH4, interrupteur et témoin lumineux">
        </div>
        <div>
