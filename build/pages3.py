...
<section class="section section--paper2">
  <div class="wrap grid g3" data-stagger>
    <article class="card"><span class="card-num">01</span><h2 class="h3">Où acheter</h2>
      <p>Les boutiques de modélisme francophones en ligne (imodel.fr, breizh-modelisme.com, evocrc.com,
      rsrc.biz) et les grandes plateformes internationales (AliExpress, Banggood, Amazon). Et d’occasion sur
      LeBonCoin.fr avec un peu de chance.</p></article>
    <article class="card"><span class="card-num">02</span><h2 class="h3">Vérifier avant de payer</h2>
      <p>Que le kit soit complet — radio, deux carrosseries et ses accessoires — et que le modèle annoncé
      soit bien celui de la photo. Prévois quatre piles AAA et un bloc chargeur USB.</p></article>
