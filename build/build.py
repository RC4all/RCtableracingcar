...
def write_llms():
    lines = ["# RC Table Racing Car", "",
             ...
             "- Ticket d'entrée : environ 90 € (voiture + tapis + bordures)",
             "- Autonomie d'une batterie LiPo : 20 à 30 minutes selon l’usage",
             "- Modèle de référence : Turbo Racing C76, châssis TC-06, environ 59 €",
             "",
             ...
             "- Livraison : RTR (Ready To Run), environ 59 €",
             "- Modèles partageant le même châssis TC-06 : C76 (59 €), C76LE (69 €), C78 (75 €)",
